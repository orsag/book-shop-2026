import { OnDestroy, Signal, ViewEncapsulation } from '@angular/core';
...
@Component({
  ...
  imports: [],
  template: `
    <div class="absolute top-0 left-0 w-full h-1 z-51 pointer-events-none">
      <progress
        class="progress progress-secondary w-full h-full block m-0 p-0"
        [value]="progressValue()"
        max="100"
      ></progress>
    </div>
