...
describe('Success', () => {
  ...
  it('should call getOrderById with the route id on init', () => {
    expect(mockOrderService.getOrderById).toHaveBeenCalledWith('d93bckja0a');
    expect(component.order()).toEqual(MOCK_CREATED_ORDER);
