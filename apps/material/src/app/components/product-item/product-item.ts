...
export class ProductItem {
  ...
  private readonly cartStore = inject(Store<CartStateRoot & UserStateRoot>);
  readonly userStore = {
    isLoggedIn: this.cartStore.selectSignal(selectIsLoggedIn),
    toggleFavorite: (productId: string) =>
      this.cartStore.dispatch(UserActions.toggleFavorite({ productId })),
  };
